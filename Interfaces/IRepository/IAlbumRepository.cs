...
namespace LicentaApp.Interfaces.IService
{
    public interface IAlbumRepository
    {
        ...
        Task<List<AlbumModel>> GetPaginatedFilteredList(string sortOrder, int? year = null, string? genre = null, int pageNumber = 0, int pageSize = 10);
        Task<int> GetTotalCountAsync(int? year = null, string? genre = null);
